...
export const projects: Project[] = [
  {
    ...
    heroImage: { src: "/images/projects/courtyard-memory/hero.png", alt: "Weathered Kerala courtyard house with timber veranda", caption: "Atmosphere study · generated placeholder image · 2026", ratio: "wide" },
    gallery: [
      { src: "/images/projects/courtyard-memory/hero.png", alt: "Shaded veranda surrounding an earthen courtyard", caption: "FIG. 01 · Existing character / atmosphere", ratio: "landscape" },
      { alt: "A close study of an existing timber threshold", caption: "FIG. 02 · Threshold and material note", tone: "earth", ratio: "portrait" },
    ],
    drawings: [
      { alt: "Conceptual courtyard plan drawing", caption: "PLAN 01 · Retained fabric + light additions · NTS", tone: "ivory", ratio: "wide" },
  ...
  },
  {
    ...
    heroImage: { alt: "Earthen interior with expressed timber structure", caption: "Material atmosphere placeholder · 2026", tone: "earth", ratio: "wide" },
    gallery: [
      { alt: "Rammed earth wall illuminated by a narrow opening", caption: "FIG. 01 · Earth / filtered light", tone: "earth", ratio: "portrait" },
      { alt: "Handmade timber joint detail", caption: "FIG. 02 · Timber connection study", tone: "forest", ratio: "landscape" },
    ],
    drawings: [
  ...
  },
  {
    ...
    heroImage: { alt: "Renovated old Kerala house in dense vegetation", caption: "Adaptive reuse atmosphere placeholder · 2025", tone: "forest", ratio: "wide" },
    gallery: [
    ...
    drawings: [
      { alt: "Retention strategy diagram", caption: "DIAGRAM 01 · Keep / repair / open / add", tone: "ivory", ratio: "wide" },
  ...
  },
  {
    ...
    heroImage: { alt: "Deep shaded veranda opening to a garden", caption: "Threshold atmosphere placeholder · 2025", tone: "maroon", ratio: "wide" },
    gallery: [
    ...
    drawings: [
      { alt: "Threshold sequence diagram", caption: "SECTION SERIES · Street to court · NTS", tone: "ivory", ratio: "wide" },
